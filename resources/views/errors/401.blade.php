            ...
            <div class="centralize-content">
                <div class="laraframe-login mx-lg-5 p-b-100">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-md-6">
                            <h2 class="text-center">{{ (isset($exception) && $exception->getMessage()) ? $exception->getMessage() : __('Unauthorized!')  }}</h2>
                            <h1 class="text-center">401</h1>
                            <p class="text-justify">{{ __('You are not authorized to access this page.') }}</p>
