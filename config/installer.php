...
use App\Http\Controllers\Core\TestSeederController;
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This title will show on the welcome page of this package.
    |
    */
    'title' => 'Codemen Web Installer',
    ...
    */
    ...
    | https://laravel.com/docs/6.0/validation#available-validation-rules
    |
    */
    'routes' => [
        'server-requirements' => [
        ...
        'seeding' => [
            ...
            'next_route' => [
                'name' => 'installer.types',
                'parameters' => 'super-admin-configuration'
            ]
        ],
        'super-admin-configuration' => [
            ...
            'next_route' => [
                'name' => 'installer.types',
                'parameters' => 'test-seeding'
            ]
        ],
        'test-seeding' => [
            'icon' => 'fa fa-database',
            'controller' => TestSeederController::class,
            'next_route' => [
                'name' => 'installer.types',
                'parameters' => 'final'
            ]
